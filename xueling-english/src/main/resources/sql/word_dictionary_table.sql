CREATE TABLE `word_dictionary` (
                                   ...
                                   `example` varchar(255) DEFAULT NULL COMMENT '英文例句',
                                   `example_translation` varchar(255) DEFAULT NULL COMMENT '例句中文翻译',
                                   `image_url` varchar(200) DEFAULT NULL COMMENT '单词插图URL',
